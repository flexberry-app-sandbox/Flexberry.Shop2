...
namespace IIS.Shop2
{
    ...
    [View("InvoiceItemE", new string[] {
            ...
            "Weight as \'Вес (кг)\'",
            "Price as \'Цена\'",
            "TotalSum as \'Сумма позиции\'"}, Hidden=new string[] {
            "Product.Name"})]
    ...
    public class InvoiceItem : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Shop2.Invoice fInvoice;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Shop2.Invoice.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.Shop2.Invoice Invoice
        {
            get
            {
                ...
                IIS.Shop2.Invoice result = this.fInvoice;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View InvoiceItemE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("InvoiceItemE", typeof(IIS.Shop2.InvoiceItem));
                }
            }
        }
    }
    ...
    public class DetailArrayOfInvoiceItem : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Shop2.DetailArrayOfInvoiceItem members)

        // *** End programmer edit section *** (IIS.Shop2.DetailArrayOfInvoiceItem members)
        ...
        /// </summary>
        public DetailArrayOfInvoiceItem(IIS.Shop2.Invoice fInvoice) : 
                base(typeof(InvoiceItem), ((ICSSoft.STORMNET.DataObject)(fInvoice)))
        {
        }
        
        public IIS.Shop2.InvoiceItem this[int index]
        {
            get
            {
                return ((IIS.Shop2.InvoiceItem)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Shop2.InvoiceItem dataobject)
        {
