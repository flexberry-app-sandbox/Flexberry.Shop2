...
namespace IIS.Shop2
{
    ...
    [View("InvoiceE", new string[] {
            ...
            "ResponsiblePerson as \'Responsible person\'"}, Hidden=new string[] {
    ...
    [View("InvoiceL", new string[] {
            ...
            "CustomerName as \'Получатель\'",
            "TotalSum as \'Сумма заказа\'",
            "TotalWeight as \'Весь заказа (кг)\'",
            "Note as \'Примечание\'",
            "ShipmentDateTime as \'Дата и время отгрузки\'",
            "ResponsiblePerson",
            "ResponsiblePerson.LastName as \'\'"}, Hidden=new string[] {
            "ResponsiblePerson.LastName"})]
    public class Invoice : IIS.Shop2.Document
    {
        
        private IIS.Shop2.InvoiceStatus fStatus = IIS.Shop2.InvoiceStatus.New;
        ...
        private IIS.Shop2.Employee fResponsiblePerson;
        
        private IIS.Shop2.DetailArrayOfInvoiceItem fInvoiceItem;
        ...
        public virtual IIS.Shop2.InvoiceStatus Status
        {
            get
            {
                ...
                IIS.Shop2.InvoiceStatus result = this.fStatus;
        ...
        public virtual IIS.Shop2.Employee ResponsiblePerson
        {
            get
            {
                ...
                IIS.Shop2.Employee result = this.fResponsiblePerson;
        ...
        public virtual IIS.Shop2.DetailArrayOfInvoiceItem InvoiceItem
        {
            get
            {
                ...
                {
                    this.fInvoiceItem = new IIS.Shop2.DetailArrayOfInvoiceItem(this);
                }
                IIS.Shop2.DetailArrayOfInvoiceItem result = this.fInvoiceItem;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View InvoiceE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("InvoiceE", typeof(IIS.Shop2.Invoice));
                }
            }
            ...
            public static ICSSoft.STORMNET.View InvoiceL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("InvoiceL", typeof(IIS.Shop2.Invoice));
                }
            }
        }
    }
